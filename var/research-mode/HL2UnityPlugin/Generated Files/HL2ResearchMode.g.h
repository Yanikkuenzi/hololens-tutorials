...
namespace winrt::HL2UnityPlugin::implementation
{
    ...
    struct WINRT_IMPL_EMPTY_BASES HL2ResearchMode_base : implements<D, HL2UnityPlugin::HL2ResearchMode, I...>
    {
...
namespace winrt::HL2UnityPlugin::factory_implementation
{
    ...
    struct WINRT_IMPL_EMPTY_BASES HL2ResearchModeT : implements<D, winrt::Windows::Foundation::IActivationFactory, I...>
    {
